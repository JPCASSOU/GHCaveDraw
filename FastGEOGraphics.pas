...
type TFastGEOGraphics = class
    ...
    public
       ...
       procedure Draw(const Point     : TGeoPoint2D);                              overload;
       procedure Draw(const Line      : TGeoLine2D);                               overload;
       procedure Draw(const Segment   : TGeoSegment2D);                            overload;
       procedure Draw(const Triangle  : TGeoTriangle2D);                           overload;
       procedure Draw(const Rectangle : TGeoRectangle);                            overload;
       procedure Draw(const Quadix    : TQuadix2D);                             overload;
       procedure Draw(const Circle    : TGeoCircle);                               overload;
       procedure Draw(const Polygon   : TGeoPolygon2D);                            overload;
       procedure Draw(const Curve     : TGeoPoint2DArray);                         overload;
       procedure Draw(const Obj       : TGeometricObject);                      overload;

       procedure DrawPixel(const x,y:Double);                                   overload;
       procedure DrawPixel(const Point : TGeoPoint2D);                             overload;

       procedure DrawPoint(const x,y:Double);                                   overload;
       procedure DrawPoint(const Point : TGeoPoint2D);                             overload;

       procedure DrawLine(const x1,y1,x2,y2:Double);                            overload;
       procedure DrawLine(const Point1,Point2:TGeoPoint2D);                        overload;
       procedure DrawLine(const Line : TGeoLine2D);                                overload;

       procedure DrawSegment(const x1,y1,x2,y2:Double);                         overload;
       procedure DrawSegment(const Point1,Point2:TGeoPoint2D);                     overload;
       procedure DrawSegment(const Seg:TGeoSegment2D);                             overload;

       procedure DrawTriangle(const x1,y1,x2,y2,x3,y3:Double);                  overload;
       procedure DrawTriangle(const Point1,Point2,Pnt3:TGeoPoint2D);               overload;
       procedure DrawTriangle(const Triangle : TGeoTriangle2D);                    overload;

       procedure DrawRectangle(const x1,y1,x2,y2:Double);                       overload;
       procedure DrawRectangle(const Point1,Point2:TGeoPoint2D);                   overload;
       procedure DrawRectangle(const Rectangle : TGeoRectangle);                   overload;

       procedure DrawQuadix(const x1,y1,x2,y2,x3,y3,x4,y4:Double);              overload;
       procedure DrawQuadix(const Point1,Point2,Pnt3,Pnt4:TGeoPoint2D);            overload;
       procedure DrawQuadix(const Quad:TQuadix2D);                              overload;

       procedure DrawCircle(const x,y,Radius:Double);                           overload;
       procedure DrawCircle(const Point : TGeoPoint2D; const Radius:Double);       overload;
       procedure DrawCircle(const Circle :TGeoCircle);                             overload;

       procedure DrawEllipse(const x,y,a,b:Double);                             overload;


       procedure DrawPolygon(const Point:array of TGeoPoint2D);                    overload;
       procedure DrawPolygon(const Polygon:TGeoPolygon2D);                         overload;

       procedure DrawCurve(Const Curve : TGeoPoint2DArray);
...
type TFastGEOCartesianGraphics = class
    ...
    private
      ...
      function ConvertXCoordinate(const x:TGeoFloat):TGeoFloat;
      function ConvertYCoordinate(const y:TGeoFloat):TGeoFloat;
      function ConverTGeoPolygon(const Polygon: TGeoPolygon2D): TGeoPolygon2D;
...
procedure TFastGEOGraphics.Draw(const Point:TGeoPoint2D);
begin
  DrawPoint(Point);
end;
(* End of Draw *)
...
procedure TFastGEOGraphics.Draw(const Line:TGeoLine2D);
begin
  DrawLine(Line);
end;
(* End of Draw *)
...
procedure TFastGEOGraphics.Draw(const Segment:TGeoSegment2D);
begin
  DrawSegment(Segment);
end;
(* End of Draw *)
...
procedure TFastGEOGraphics.Draw(const Triangle:TGeoTriangle2D);
begin
...
procedure TFastGEOGraphics.Draw(const Rectangle:TGeoRectangle);
begin
...
procedure TFastGEOGraphics.Draw(const Circle:TGeoCircle);
begin
  DrawCircle(Circle);
end;
(* End of Draw *)
...
procedure TFastGEOGraphics.Draw(const Polygon:TGeoPolygon2D);
begin
  DrawPolygon(Polygon);
end;
(* End of Draw *)
...
procedure TFastGEOGraphics.Draw(Const Curve:TGeoPoint2DArray);
begin
  DrawCurve(Curve);
end;
(* End of Draw *)
...
procedure TFastGEOGraphics.DrawPixel(const Point : TGeoPoint2D);
begin
...
procedure TFastGEOGraphics.DrawPoint(const Point : TGeoPoint2D);
begin
...
procedure TFastGEOGraphics.DrawLine(const Point1,Point2:TGeoPoint2D);
begin
...
procedure TFastGEOGraphics.DrawLine(const Line : TGeoLine2D);
begin
...
procedure TFastGEOGraphics.DrawSegment(const Point1,Point2:TGeoPoint2D);
begin
...
procedure TFastGEOGraphics.DrawSegment(const Seg:TGeoSegment2D);
begin
...
procedure TFastGEOGraphics.DrawTriangle(const Point1,Point2,Pnt3:TGeoPoint2D);
begin
...
procedure TFastGEOGraphics.DrawTriangle(const Triangle : TGeoTriangle2D);
begin
...
procedure TFastGEOGraphics.DrawRectangle(const Point1,Point2:TGeoPoint2D);
begin
...
procedure TFastGEOGraphics.DrawRectangle(const Rectangle : TGeoRectangle);
begin
...
procedure TFastGEOGraphics.DrawQuadix(const Point1,Point2,Pnt3,Pnt4:TGeoPoint2D);
begin
  DrawSegment(Point1,Point2);
  DrawSegment(Point2,Pnt3);
...
procedure TFastGEOGraphics.DrawCircle(const Point : TGeoPoint2D; const Radius:Double);
begin
...
procedure TFastGEOGraphics.DrawCircle(const Circle :TGeoCircle);
begin
...
procedure TFastGEOGraphics.DrawPolygon(const Point:array of TGeoPoint2D);
var
  i : Integer;
  j : Integer;
begin
...
procedure TFastGEOGraphics.DrawPolygon(const Polygon:TGeoPolygon2D);
var
  i : Integer;
  j : Integer;
begin
...
procedure TFastGEOGraphics.DrawCurve(Const Curve : TGeoPoint2DArray);
var
  i : Integer;
begin
...
function TFastGEOCartesianGraphics.ConvertXCoordinate(const x: TGeoFloat): TGeoFloat;
begin
...
function TFastGEOCartesianGraphics.ConvertYCoordinate(const y: TGeoFloat): TGeoFloat;
begin
...
procedure TFastGEOCartesianGraphics.Draw(const Circle: TGeoCircle);
begin
  DrawCircle(Circle);
end;
...
procedure TFastGEOCartesianGraphics.Draw(const Polygon: TGeoPolygon2D);
begin
  DrawPolygon(Polygon);
end;
...
procedure TFastGEOCartesianGraphics.Draw(const Curve: TGeoPoint2DArray);
begin
end;


procedure TFastGEOCartesianGraphics.Draw(const Line: TGeoLine2D);
begin
  DrawLine(Line);
end;


procedure TFastGEOCartesianGraphics.Draw(const Point: TGeoPoint2D);
begin
  DrawPoint(Point);
end;


procedure TFastGEOCartesianGraphics.Draw(const Segment: TGeoSegment2D);
begin
  DrawSegment(Segment);
end;


procedure TFastGEOCartesianGraphics.Draw(const Rectangle: TGeoRectangle);
begin
  DrawRectangle(Rectangle);
end;


procedure TFastGEOCartesianGraphics.Draw(const Triangle: TGeoTriangle2D);
begin
  DrawTriangle(Triangle);
end;


procedure TFastGEOCartesianGraphics.DrawCircle(const Point :  TGeoPoint2D; const Radius: Double);
begin
...
procedure TFastGEOCartesianGraphics.DrawCircle(const Circle : TGeoCircle);
begin
  DrawCircle(Circle.x,Circle.y,Circle.Radius);
end;


procedure TFastGEOCartesianGraphics.DrawCurve(const Curve: TGeoPoint2DArray);
begin
end;
...
procedure TFastGEOCartesianGraphics.DrawLine(const Point1, Point2: TGeoPoint2D);
begin
  DrawLine(Point1.x,Point1.y,Point2.x,Point2.y);
end;


procedure TFastGEOCartesianGraphics.DrawLine(const Line : TGeoLine2D);
begin
  DrawLine(Line[1],Line[2]);
end;
...
procedure TFastGEOCartesianGraphics.DrawPixel(const Point :  TGeoPoint2D);
begin
  DrawPixel(Point.x,Point.y);
end;
...
procedure TFastGEOCartesianGraphics.DrawPoint(const Point :  TGeoPoint2D);
begin
  DrawPoint(Point.x,Point.y);
end;


procedure TFastGEOCartesianGraphics.DrawPolygon(const Polygon: TGeoPolygon2D);
begin
  FGraphicsContext.DrawPolygon(ConverTGeoPolygon(Polygon));
end;


procedure TFastGEOCartesianGraphics.DrawPolygon(const Point: array of TGeoPoint2D);
begin
end;
...
procedure TFastGEOCartesianGraphics.DrawQuadix(const Point1, Point2, Pnt3,Pnt4: TGeoPoint2D);
begin
...
procedure TFastGEOCartesianGraphics.DrawRectangle(const Point1,Point2: TGeoPoint2D);
begin
  DrawRectangle(Point1.x,Point1.y,Point2.x,Point2.y);
end;


procedure TFastGEOCartesianGraphics.DrawRectangle(const Rectangle :  TGeoRectangle);
begin
  DrawRectangle(Rectangle[1],Rectangle[2]);
end;
...
procedure TFastGEOCartesianGraphics.DrawSegment(const Point1,Point2: TGeoPoint2D);
begin
...
procedure TFastGEOCartesianGraphics.DrawSegment(const Seg: TGeoSegment2D);
begin
  DrawSegment(Seg[1],Seg[2]);
end;


procedure TFastGEOCartesianGraphics.DrawTriangle(const Triangle :  TGeoTriangle2D);
begin
...
procedure TFastGEOCartesianGraphics.DrawTriangle(const Point1, Point2,Pnt3: TGeoPoint2D);
begin
...
function TFastGEOCartesianGraphics.ConverTGeoPolygon(const Polygon: TGeoPolygon2D): TGeoPolygon2D;
var
  i : Integer;
begin
