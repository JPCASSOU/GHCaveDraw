...
// cas des projection cylindrique oblique définies par un point et une direction
// définition d'un ancètre commun aux différentes projections
...
type
  ...
  protected
    ...
    fTheta0 : string; // obliquité de l'indicatrice
    fTheta0Real : real; // valeur en radian de l'obliquité précédente
